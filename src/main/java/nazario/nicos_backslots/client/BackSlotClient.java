...
import nazario.nicos_backslots.client.config.BackSlotClientConfig;
...
public class BackSlotClient implements ClientModInitializer {
    public static BackSlotClientConfig CONFIG;
    ...
    public void onInitializeClient() {
        AutoConfig.register(BackSlotClientConfig.class, GsonConfigSerializer::new);
        ...
        CONFIG = AutoConfig.getConfigHolder(BackSlotClientConfig.class).getConfig();
    }
}
